...
<body>
    <div>
        <form action="" method="post" novalidate>
            ...
            <?php endif; ?>
            Question:<br> 
            <input type="text" name="question" style="width: 700px;" value="<?=isset($data["question"]) ? $data["question"] : ""?>"><br>
            <?php if (isset($errors["options"])) : ?>
                <span class="error"><?=$errors["options"]?></span><br>
            <?php endif; ?>
            Options:<br>
            <textarea name="options"  cols="109" rows="10"><?php if (isset($data["options"])) : ?><?php foreach ($data["options"] as $con) :?><?=$con."\r\n"?><?php endforeach; ?><?php endif; ?>
            </textarea><br>
            ...
            <?php if (isset($data["can_multiple"])) : ?>
            ...
            <?php endif; ?>
            Deadline: <input type="date" name="deadline" value="<?=$data["deadline"] ?? "" ?>"><br>
